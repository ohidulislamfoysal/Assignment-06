...
<div className="mt-8 flex gap-6 text-2xl text-zinc-500">
  <a href="#" className="hover:text-pink-500 transition duration-300 hover:scale-110">
    <FaInstagram />
  </a>
  <a href="#" className="hover:text-blue-500 transition duration-300 hover:scale-110">
    <FaFacebook />
  </a>
  <a href="#" className="hover:text-white transition duration-300 hover:scale-110">
    <FaXTwitter />
  </a>
</div>
          </div>
